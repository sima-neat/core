---
title: "環境變數清單"
description: "本儲存庫中參考的所有環境變數的完整清單。"
sidebar_position: 2
---

# 環境變數清單

這是從原始碼、測試、教學、腳本和持續整合 (CI) 中偵測到的所有環境變數清單。
...
## 使用者介面 `SIMA_*` 檔案清單 (`docs/reference/environment-variables/index.md`)
