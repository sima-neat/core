---
title: "Інвентаризація змінних середовища"
description: "Повний перелік змінних середовища, які використовуються в цьому репозиторії."
sidebar_position: 2
---

# Інвентаризація змінних середовища

Це повний перелік змінних середовища, виявлених у вихідному коді, тестах, навчальних матеріалах, скриптах і системах безперервної інтеграції.

## Середовище виконання / Бібліотека (`src/`)
...
## Список документації, орієнтованої на користувачів `SIMA_*` (`docs/reference/environment-variables/index.md`).
