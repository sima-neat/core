...
Блоки команд у посібниках із налаштування та розробки застосунків позначено та кольорово закодовано відповідно до середовища, у якому вони виконуються, тож вам не доведеться вгадувати, де їх вводити:
...
Блок, позначений кількома середовищами, наприклад `sdk or devkit$`, виконується однаково в будь-якому з них.
