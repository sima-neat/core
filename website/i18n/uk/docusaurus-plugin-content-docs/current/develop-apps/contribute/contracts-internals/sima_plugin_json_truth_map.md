---
title: "JSON-схема плагінів SIMA (історичний знімок)"
description: "Історична карта використання JSON-полів етапами конвеєра моделі SIMA станом на лютий 2026 року"
sidebar_position: 2
slug: /develop-apps/contribute/sima_plugin_json_truth_map
---

# JSON-схема плагінів SIMA (історичний знімок)

_Дата знімка: 2026-02-17_

Цей документ зберігає результати перевірки використання JSON-полів етапами конвеєра моделі SIMA станом на лютий 2026 року. Згадки про «поточну» поведінку нижче стосуються саме цього знімка.

> **Історичний контракт:** Наведені нижче назви плагінів та обов’язкові JSON-поля не є контрактом розгортання Platform 3.0.0. Універсальний BoxDecode тепер використовує `neatobjectdecode`, який налаштовується через типізований етап маніфесту та властивості середовища виконання. Старі вимоги `simaaiboxdecode` нижче не визначають конфігурацію на рівні застосунку. Актуальні вимоги до конфігурації та сумісних пакетів див. у [контракті контексту статичного маніфесту SIMA](../start-here/architecture.md).
