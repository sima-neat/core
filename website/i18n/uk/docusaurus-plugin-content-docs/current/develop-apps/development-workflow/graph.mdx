...
`GraphLinkOptions` додає налаштування допуску. Перезберіть застосунки та плагіни C++ для Core ABI 5, `libsima_neat.so.5`. Використовуйте відповідні заголовки та пакети середовища виконання.
