...
- With `mla_only`, `info()` describes the MLA's own INT8 or BF16 contract. `TensorInfo.quant` carries the
  scale and zero point of each INT8 tensor; it comes from the archive and is absent in the default
  mode.
