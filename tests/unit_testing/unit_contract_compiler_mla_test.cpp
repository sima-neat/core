...
RUN_TEST("unit_contract_compiler_mla_test", ([] {
  ...
  require(compiled.runtime_contract.logical_inputs.front().size_bytes == expected_logical_input_bytes,
  ...
  require(compiled.runtime_contract.input_bindings.front().src_physical_size_bytes == 1228800U,
