...
RUN_TEST("unit_modelpack_multi_mla_plan_test", ([] {
           ...
           require(std::any_of(
                       interleaved_plan.infer.begin(), interleaved_plan.infer.end(),
           ...
           require_proof_unchanged(prefix_full_proof, prefix_model.dmabuf_plan_admission().proof);
           ...
           if (const char* yolo26_package =
             ...
             require_proof_unchanged(full_proof, yolo26_model.dmabuf_plan_admission().proof);
           ...
           if (const char* yolo_package =
             ...
             require_proof_unchanged(full_proof, yolo_model.dmabuf_plan_admission().proof);
