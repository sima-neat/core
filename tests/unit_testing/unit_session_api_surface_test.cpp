...
int main() {
  ...
  static_assert(
      std::is_same_v<decltype(std::declval<Session&>().build(std::declval<const TensorList&>())),
                     Run>,
  ...
  static_assert(
      std::is_same_v<decltype(std::declval<Session&>().build(std::declval<const SampleList&>())),
                     Run>,
      "Session::build(SampleList) should resolve to Run");
  static_assert(
      std::is_same_v<decltype(std::declval<Session&>().run(std::declval<const TensorList&>())),
                     TensorList>,
  ...
  static_assert(
      std::is_same_v<decltype(std::declval<Session&>().run(std::declval<const SampleList&>())),
                     SampleList>,
