      ...
      {"name":"out_3"}, {"name":"out_4"}, {"name":"out_5"}
           ...
           for (const char* geometry_field :
                {"preproc_original_width", "preproc_original_height",
                 "preproc_resized_width", "preproc_resized_height", "preproc_scaled_width",
                 "preproc_scaled_height", "preproc_pad_left", "preproc_pad_right",
                 "preproc_pad_top", "preproc_pad_bottom", "preproc_resize_mode",
