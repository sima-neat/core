...
RUN_TEST("unit_dequant_processcvu_contract_equivalence_test", ([] {
  ...
  dequant_facts.input_quant =
      simaai::neat::pipeline_internal::sima::QuantStaticSpec{
          simaai::neat::pipeline_internal::sima::QuantGranularity::PerTensor,
          -1,
          {0.125},
          {-7}};
  ...
  require(adapted.runtime_contract.output_order.size() == expected.runtime_contract.output_order.size(),
