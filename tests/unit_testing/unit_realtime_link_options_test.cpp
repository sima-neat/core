...
run_one_raw_sample(const simaai::neat::RealtimeMuxByStream& options, int stream_count = 1,
...
void verify_raw_frame_cap_blocks_after(
    const simaai::neat::RealtimeMuxByStream& options, int stream_count, int admitted_frames,
    const std::string& label, bool use_explicit_link_stream_ids = true,
    const std::vector<simaai::neat::RealtimeMuxByStream>& additional_edge_options = {}) {
  simaai::neat::runtime::DownstreamTarget target{
      simaai::neat::runtime::DownstreamTarget::Kind::PipelineInput,
      0U,
      simaai::neat::graph::kInvalidPort,
...
void verify_per_stream_cap_blocks_after_two_raw_frames() {
  simaai::neat::RealtimeMuxByStream options;
...
void verify_asymmetric_fan_in_uses_strictest_caps() {
  simaai::neat::RealtimeMuxByStream first_options;
  ...
  simaai::neat::RealtimeMuxByStream second_options = first_options;
...
int main() {
  try {
    ...
    simaai::neat::RealtimeMuxByStream default_options;
    ...
    simaai::neat::RealtimeMuxByStream explicit_total_options;
    ...
    simaai::neat::RealtimeMuxByStream zero_options;
    ...
    simaai::neat::RealtimeMuxByStream zero_total_options;
    ...
    simaai::neat::RealtimeMuxByStream negative_options;
    ...
    simaai::neat::RealtimeMuxByStream negative_total_options;
