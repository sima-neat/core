...
RUN_TEST(
    "unit_tensorbuffer_bind_preserve_source_view_test", ([] {
      ...
      require(simaai::gst::tensor_buffer_build_publish_view_from_contract(
                  buffer.get(), contract, simaai::gst::TensorBufferProducerKind::ProcessMla, &view,
                  &err),
      ...
      err.clear();
      require(simaai::gst::tensor_buffer_bind_inputs(view, request, false, false, &bindings, &err),
