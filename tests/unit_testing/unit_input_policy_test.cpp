...
RUN_TEST(
    "unit_input_policy_test", ([] {
      ...
      // Session bounded mode: explicit seed/max should be preserved with origins.
      {
        ...
        require(out.shape_limits.seed_width == 320, "session policy: user seed width should win");
        require(out.shape_limits.seed_height == 240, "session policy: user seed height should win");
        require(out.shape_limits.seed_depth == 3, "session policy: user seed depth should win");
