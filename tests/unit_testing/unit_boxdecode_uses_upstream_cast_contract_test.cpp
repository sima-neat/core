...
simaai::neat::Tensor make_fp32_head(int logical_index,
...
RUN_TEST("unit_boxdecode_uses_upstream_cast_contract_test", ([] {
           using namespace simaai::neat;
           ...
           const Sample ingress =
               sample_from_tensors(TensorList{reg0, reg1, reg2, cls0, cls1, cls2});
           ...
           require(compiled.stages[0].transport.has_value(), "first stage should compile as cast transport");
           ...
           require(compiled.stages[1].boxdecode->payload.decode_type_option ==
           ...
           require(standalone_compiled.stages.size() == 1U,
                   "expected one standalone boxdecode stage");
           ...
           Tensor wrap_cls0 =
               make_fp32_head(3, {80, 80, 80}, 2150400, "cast_5/class_prob_0", 8.0f);
           Tensor wrap_cls1 =
               make_fp32_head(4, {80, 40, 40}, 4198400, "cast_6/class_prob_1", 8.0f);
           Tensor wrap_cls2 =
               make_fp32_head(5, {80, 20, 20}, 4710400, "cast_7/class_prob_2", 8.0f);
