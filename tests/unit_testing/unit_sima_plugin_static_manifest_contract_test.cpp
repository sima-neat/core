...
RUN_TEST("unit_sima_plugin_static_manifest_contract_test", ([] {
           ...
           require(pre_stage->payload.processcvu.default_output_names != nullptr &&
                       std::string(pre_stage->payload.processcvu.default_output_names[0]) == "output_rgb_image",
           ...
           require(pre_stage->payload.processcvu.primary_output_name != nullptr &&
                       std::string(pre_stage->payload.processcvu.primary_output_name) == "output_rgb_image",
           ...
           require(pre_stage->payload.processcvu.normalize == 1,
                   "pre stage normalize payload mismatch");
           ...
           require(pre_stage->logical_inputs_len == 1,
                   "pre stage logical input count mismatch");
           require(pre_stage->input_bindings_len == 1,
                   "pre stage input binding count mismatch");
           require(pre_stage->physical_outputs_len == 1,
                   "pre stage physical output count mismatch");
           require(pre_stage->logical_outputs_len == 1,
                   "pre stage logical output count mismatch");
           require(box_stage->logical_inputs_len == 1,
                   "box stage logical input count mismatch");
           require(box_stage->logical_inputs != nullptr,
                   "box stage logical inputs payload missing");
           ...
           require(box_stage->input_bindings_len == 1,
                   "box stage input binding count mismatch");
           ...
           require(box_stage->payload.boxdecode.topk == 100,
                   "box stage payload topk mismatch");
           ...
           require(mla_stage->payload.processmla.batch_size == 1,
                   "mla payload batch_size mismatch");
