...
int main() {
  try {
    ...
    const std::vector<PackageExpectation> neat_packages = {
        ...
        {"linux-image-6.18.3-modalix", "b4593-kernel"},
    };
    ...
    require_package_version("libcamera", "2.1.3+neat2");
    require_package_version("libcamera-tools", "2.1.3+neat2");
    require_package_version("libcamera-dev", "2.1.3+neat2");
