...
RUN_TEST(
    "unit_video_sender_adaptive_ingress_test", ([] {
...

      {
        ...
        const auto transport = simaai::neat::device_visible_nv12_materialization_spec_or_throw(
        ...
        require(transport.planes[0].stride_bytes == 704 && transport.planes[1].stride_bytes == 704,
