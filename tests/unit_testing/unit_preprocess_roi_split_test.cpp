...
RUN_TEST("unit_preprocess_roi_split_test", ([] {
           ...
           simaai::neat::TensorList split =
               simaai::neat::stages::internal::split_preproc_roi_output_for_stage(
                   batched, meta, kCapacity, info);
...

           {
             ...
             simaai::neat::TensorList partial_split =
                 simaai::neat::stages::internal::split_preproc_roi_output_for_stage(
                     batched, partial, kCapacity, info);
             require(partial_split.size() == 2U,
                     "ROI split: partial valid_count should limit outputs");
             require(partial_split[0].byte_offset == 0 &&
                         partial_split[1].byte_offset == kSlotBytes,
