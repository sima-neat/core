...
RUN_TEST("graph_migration_phaseA4_run_export_test", [] {
  ...
  require(json.at("run")
                  .at("graph_metrics")
                  .at("throughput")
                  .at("numerator_counter")
                  .get<std::string>() == "outputs_pulled",
  ...
  require(measured_saved.at("run").contains("graph_e2e_latency_ms"),
          "saved measured export should contain graph E2E latency");
  require(measured_saved.at("run")
                  .at("graph_metrics")
                  .at("throughput")
                  .at("scope")
                  .get<std::string>() == "measured_window",
          "saved measured export should preserve measured-window throughput scope");
  require(measured_saved.at("run").contains("output_materialization"),
          "saved measured export should preserve output materialization semantics");
  require(measured_json.at("run")
