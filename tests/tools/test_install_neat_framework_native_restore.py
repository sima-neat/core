...
'''
        ...
        # PCIe staging packages intentionally use Conflicts/Replaces to hand
        # off canonical platform packages, so the atomic transaction must be
        # allowed to perform those declared removals.
