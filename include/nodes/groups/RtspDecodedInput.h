...
struct RtspDecodedInputOptions {
  ...
  int h264_parse_config_interval = -1; ///< SPS/PPS reinjection interval for the H.264 parser (-1 = default).
  ...
  std::string decoder_next_element; ///< Optional next-element selector ("CVU" or "APU") for `neatdecoder`.
