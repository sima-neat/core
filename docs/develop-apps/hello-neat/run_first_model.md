...
* [`ModelOptions`](/tutorials/configure-model-options) tells Neat how to prepare the image and decode the detector output.
...
For a deeper explanation of box decoding, thresholds, NMS, and detector output structure, continue with [Read Detection Boxes from Model Output](/tutorials/read-detection-boxes).
