...
`GraphLinkOptions` adds admission settings. Rebuild C++ applications and plugins against Core ABI 5, `libsima_neat.so.5`. Use matching headers and runtime packages.
