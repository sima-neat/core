...
| Read HTTP multipart MJPEG | `nodes::HttpSource(...)`, `MultipartJpegDemux()`, `JpegParse()` | `pyneat.nodes.http_source(...)`, `pyneat.nodes.multipart_jpeg_demux()`, `pyneat.nodes.jpeg_parse()` |
