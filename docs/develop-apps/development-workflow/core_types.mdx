...
auto run = graph.build(simaai::neat::Sample{});
...
- [Pass NumPy Arrays to the Model](/tutorials/009-pass-numpy-to-model)
- [Feed Models That Take Multiple Inputs](/tutorials/010-feed-multi-input-model)
- [Read and Interpret Model Output](/tutorials/011-interpret-model-output)
