...
sidebar_position: 5
slug: /develop-apps/contribute/b4593-dmabuf-package-contract
---

# B4593 DMA-BUF Package Contract

The `feat/4593-platform-cohort` integration is intentionally restricted to
...
| Libcamera override set | `libcamera`, `libcamera-dev`, and `libcamera-tools` at `2.1.3+neat2` |
...
| Memory override set | `simaai-memory-lib` and `simaai-memory-lib-dev` at `2.1.1-0neat5` |
...
python3 -m unittest \
  ...
  tests.tools.test_b4593_package_contract \
