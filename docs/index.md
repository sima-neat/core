...
<div class="overview-link-columns">
  <section class="overview-link-panel overview-link-panel-start">
    ...
    <ul class="overview-link-list">
      ...
      <li><a class="overview-link-card" href="/software/getting-started/minimal_example/"><strong>Hello Neat!</strong><span>Validate your environment with a minimal Neat application.</span></a></li>
      <li><a class="overview-link-card" href="/software/getting-started/programming-model/overview/"><strong>Programming Model</strong><span>Learn the `Model`, `Session`, and `Run` workflow in more detail.</span></a></li>
    </ul>
  </section>
