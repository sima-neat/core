...
For the B4586 integration branch, the kernel, libcamera, and memory overrides
form one package contract. Contributors should follow the
[B4586 DMA-BUF package contract](/develop-apps/contribute/b4586-dmabuf-package-contract/)
