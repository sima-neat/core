...
The installed framework also provides the `neat` environment command. Run it from either the Neat SDK or DevKit to see installed component versions, installed `sima-cli` playbooks, and whether newer artifacts are available.
