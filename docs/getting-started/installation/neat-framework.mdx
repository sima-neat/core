...
If you prefer building from source, follow the [Build](/getting-started/build) guide.
...
Continue with [Hello Neat!](/getting-started/minimal_example) to validate your setup with a minimal app.
