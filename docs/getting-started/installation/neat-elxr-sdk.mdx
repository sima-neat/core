...
The NEAT eLxr SDK source code is available on GitHub at [sima-neat/elxr-sdk](https://github.com/sima-neat/elxr-sdk).
...
2. Set up the SDK and pair it with your DevKit:
...
- Mounted folder names such as `/workspace` and `/sdk-workspace` are defaults and can be changed during the SDK setup process.
...
3. Install the [Codex Extension](https://marketplace.visualstudio.com/items?itemName=openai.chatgpt) in VS Code and sign in.
