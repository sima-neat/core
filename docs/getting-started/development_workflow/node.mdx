...
- [`SimaBoxDecode`](/how-to/boxdecode_decode_types): detection postprocessing that decodes model heads into bounding boxes and uses upstream preprocess metadata for coordinate mapping.
