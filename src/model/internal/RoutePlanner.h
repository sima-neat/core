...
RouteMaterializationPlan build_semantic_route_plan(const Model::Options& options,
                                                   const ModelSemantics& semantics,
                                                   const RouteCapability* capability = nullptr,
                                                   const ModelPack* pack = nullptr);
RouteMaterializationPlan build_session_route_plan(const Model::Options& options,
                                                  const ModelSemantics& semantics,
                                                  const RouteCapability* capability = nullptr,
                                                  const ModelPack* pack = nullptr);
