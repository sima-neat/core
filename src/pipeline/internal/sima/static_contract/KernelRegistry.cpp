...
constexpr std::array<KernelDescriptor, 40> kRegistry = {{
    ...
    {"2.1.3", "EV74", "cast_transform", OpKind::Cast, 1, 1, 1, 1},
    {"2.1.3", "EV74", "cast", OpKind::Cast, 1, 1, 1, 1},
    {"2.1.3", "EV74", "quantization_transform", OpKind::Quantize, 1, 1, 1, 1},
    {"2.1.3", "EV74", "tessellation_transform", OpKind::Tessellate, 1, 1, 1, 1},
    {"2.1.3", "EV74", "pack_transform", OpKind::Pack, 2, kMany, 1, 1},
    {"2.1.3", "MLA", "", OpKind::Mla, 1, kMany, 1, kMany},
    {"2.1.3", "EV74", "unpack_transform", OpKind::Unpack, 1, 1, 1, kMany},
    {"2.1.3", "EV74", "slice_transform", OpKind::Slice, 1, 1, 1, 1},
    {"2.1.3", "EV74", "reshape_transform", OpKind::Reshape, 1, 1, 1, 1},
    {"2.1.3", "EV74", "batch_flatten_transform", OpKind::Reshape, 1, 1, 1, 1},
    {"2.1.3", "EV74", "detessellation_transform", OpKind::Detessellate, 1, 1, 1, 1},
