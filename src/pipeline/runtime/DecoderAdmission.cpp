...
std::shared_ptr<Node> make_kernel_reserved_decoder(const DecoderAdmissionCandidate& candidate) {
  /*
  ...
  return std::make_shared<RuntimeAdmittedSimaDecode>(candidate.options, std::move(props));
}
